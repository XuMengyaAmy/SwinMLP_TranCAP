...
class SwinMLP_Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('x output from the BasicLayer', x.shape) # x output from the BasicLayer torch.Size([3, 49, 768])

        # Added by menya for decoder
        # x = x.view(x.shape[0], -1, self.d_model)
        # print('x output from the encoder', x.shape) # x output from the encoder torch.Size([3, 147, 256])
...
# class Linear512_Vision_Swin_MLP_patchemd_separate_with_attmask(AttModel):
class SwinMLP_TranCAP(AttModel):
    ...
    def __init__(self, opt):
        super(SwinMLP_TranCAP, self).__init__(opt)
        self.opt = opt
    ...
    def core(self, it, fc_feats_ph, att_feats_ph, memory, state, mask):
        ...
        # print('mask in core', mask.shape) # mask in core torch.Size([3, 1, 49]
...
# ****************************************************************************************** #
# Training 的过程没有问题， val过程有问题
# Epoch 0, lr 0.0003:  93%|███████████████████████████████████████████████████████████████████████▌     | 13095/14094 [06:04<00:27, 35.88it/s]
# Val:   0%|                                                                                                         | 0/1646 [00:00<?, ?it/s]Traceback (most recent call last):
#   File "tools/train_vision_transformer.py", line 422, in <module>
#     train(opt)
#   File "tools/train_vision_transformer.py", line 336, in train
#     val_loss, predictions, lang_stats = eval_utils.eval_split(
#   File "/home/ren2/data2/mengya/mengya_code/main_ImageCaptioning.pytorch/captioning/utils/eval_utils.py", line 222, in eval_split
#     seq, seq_logprobs = model(fc_feats, att_feats, att_masks, opt=tmp_eval_kwargs, mode='sample')
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/modules/module.py", line 1102, in _call_impl
#     return forward_call(*input, **kwargs)
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/parallel/data_parallel.py", line 168, in forward
#     outputs = self.parallel_apply(replicas, inputs, kwargs)
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/parallel/data_parallel.py", line 178, in parallel_apply
#     return parallel_apply(replicas, inputs, kwargs, self.device_ids[:len(replicas)])
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/parallel/parallel_apply.py", line 86, in parallel_apply
#     output.reraise()
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/_utils.py", line 434, in reraise
#     raise exception
# TypeError: Caught TypeError in replica 0 on device 0.
# Original Traceback (most recent call last):
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/parallel/parallel_apply.py", line 61, in _worker
#     output = module(*input, **kwargs)
#   File "/home/ren2/anaconda3/envs/Captioning_Zoo/lib/python3.8/site-packages/torch/nn/modules/module.py", line 1102, in _call_impl
#     return forward_call(*input, **kwargs)
#   File "/home/ren2/data2/mengya/mengya_code/main_ImageCaptioning.pytorch/captioning/models/CaptionModel.py", line 38, in forward
#     return getattr(self, '_'+mode)(*args, **kwargs)
#   File "/home/ren2/data2/mengya/mengya_code/main_ImageCaptioning.pytorch/captioning/models/AttModel.py", line 292, in _sample
...
#   File "/home/ren2/data2/mengya/mengya_code/main_ImageCaptioning.pytorch/captioning/models/AttModel.py", line 170, in get_logprobs_state
