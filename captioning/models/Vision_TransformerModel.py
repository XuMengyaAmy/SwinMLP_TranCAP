...
class Vision_TransformerModel(AttModel):
    ...
    def __init__(self, opt):
        super(Vision_TransformerModel, self).__init__(opt)
        self.opt = opt
    ...
    def _prepare_feature_forward(self, att_feats, att_masks=None, seq=None):
        # ============== patch related code ===================== #
        # print('before patching:', att_feats.shape) # torch.Size([5, 3, 224, 224])
        att_feats = self._prepare_patches_forward(att_feats)
        # print('after patching:', att_feats.shape) # torch.Size([5, 196, 2048])
        # ================================================================== #
    ...
    def core(self, it, fc_feats_ph, att_feats_ph, memory, state, mask):
        ...
        # print('state', state)
        # print('it', it)
        # print('ys', ys.shape) # torch.Size([50, 17])
