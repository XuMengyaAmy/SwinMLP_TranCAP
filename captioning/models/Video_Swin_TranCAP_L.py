...
class SwinTransformer3D_Encoder(nn.Module):
    ...
    def forward(self, x):
        ...
        #(36, 3, 224, 224) --> (9, 4, 3, 224, 224) --> (9, 3, 4, 224, 224) --> 3gpus, each gpu torch.Size([3, 3, 4, 224, 224])
...
class Video_Swin_TranCAP_L(AttModel):
    ...
    def __init__(self, opt):
        super(Video_Swin_TranCAP_L, self).__init__(opt)
        self.opt = opt
