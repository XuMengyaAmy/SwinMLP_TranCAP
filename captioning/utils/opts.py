# ***************************************** mengya: it's about video vision parameters***************************************************************************** *
...
def parse_opt():
    ...
    # ======================= added by mengya: parameters about video vision transformer model ======================= #
    ...
    #                 help='path to the json file containing additional info and vocab')
    # parser.add_argument('--input_fc_dir', type=str, default=None,
    #                 help='path to the directory containing the preprocessed fc feats')
    # parser.add_argument('--input_att_dir', type=str, default=None,
    #                 help='path to the directory containing the preprocessed att feats')
