...
class Dataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        #         self.split_ix['train'].append(ix) # ix 刚好和 “id”是一致的。所以 self.split_ix['train']里的 ix 并不是从0开始并且顺序加1的索引值， 而是在“train+val”世界里的索引值
        #     elif img['split'] == 'val':
        #         self.split_ix['val'].append(ix)
        #     elif img['split'] == 'test':
        #         self.split_ix['test'].append(ix)
        ...
        train_useful_start_idx, val_useful_start_idx = get_useful_start_idx(sequence_length=self.opt.sequence_length, list_each_length=[149, 137, 134, 148, 149, 129, 149, 135, 149, 138, 146, 147, 148, 149], \
        ...
        for i in range(num_train_we_use):
            for j in range(self.opt.sequence_length): # self.opt.sequence_length
    ...
    def __getitem__(self, index):
        ...
        # ix 刚好和 “id”是一致的。所以 self.split_ix['train']里的 ix 并不是从0开始并且顺序加1的索引值， 而是在“train+val”世界里的索引值 
        # 在 “train+val”的世界里，也就是在 self.info['images'] 的世界里， ix 和 self.info['images'][ix]['id']是一样的。
