'''
This code is used to generate the daisi_val.json file.
...
The coco-style output json file just contain the imgid which belong to split: val
...
def main(params):
    ...
    for img in imgs:
        if img["split"] == "val":
            print("val id", img["imgid"])

            images_element = {"file_name": str(img["imgid"])+'.jpg', "id":img["imgid"], "split": "val"}
    ...
    val_output = {"images": images, "type": "captions", "annotations":annotations}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_json', default='data/data_daisi/daisi_val.json', help='output json file') 
