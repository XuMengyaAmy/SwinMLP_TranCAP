...
def main(params):
    ...
    for i,img in enumerate(imgs):
        ...
        I = Image.open(os.path.join(params['images_root'], img['filepath'], 'left_frames', img['filename'])).convert('RGB')
        print('processing', os.path.join(params['images_root'], img['filepath'], 'left_frames', img['filename']))
        I = preprocess(I)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', default='./data/data_miccai18/miccai18_resnet18_feat512', help='output h5 file')
