...
def train(opt):
    ...
    if opt.noamopt:
        ...
        assert opt.caption_model in ['transformer', 'bert', 'm2transformer', 'vision_transformer', 'video_vision_transformer', 'video_vision_transformer_v2', 'Video_Vision_TransformerModel_conv_v3'], 'noamopt can only work with transformer'
    ...
    while True: # mengya: 如果出现错误的话，可以继续循环。 while True 语句中一定要有结束该循环的break语句，否则会一直循环下去的。
        ...
        # sequenced ix mengya !!!!!!!!!! [986, 987, 988, 161, 162, 163, 1186, 1187, 1188, 957, 958, 959, 400, 401, 402, 403, 404, 405, 1515, 1516, 1517, 559, 560, 561, 547, 548, 549]
        # ************************************************************************************************* #
