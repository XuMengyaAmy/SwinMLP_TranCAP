...
def train(opt):
    ...
    if opt.noamopt:
        ...
        assert opt.caption_model in ['transformer', 'bert', 'm2transformer', 'vision_transformer', 'Vision_TokenMixer_TransformerModel', 
        'Vision_Swin_TransformerModel', 'Vision_Swin_TransformerModel_patchemd_separate'], 'noamopt can only work with transformer'
...
if __name__ == '__main__':
    ...
    print('pool_size        :', opt.pool_size)    # 3
    print('=====================================================================')
