...
def train(opt):
    ...
    while True: # mengya: 如果出现错误的话，可以继续循环。 while True 语句中一定要有结束该循环的break语句，否则会一直循环下去的。
        ...
        # print('opt.noamopt', opt.noamopt) # False
        # print('opt.reduce_on_plateau', opt.reduce_on_plateau) # False
        if epoch_done:
            if not opt.noamopt and not opt.reduce_on_plateau:
                print('mengya: learning_rate_decay_start 1111111111111')
