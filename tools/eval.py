...
# Input paths
parser.add_argument('--model', type=str, default='log_best_models/miccai18/log_miccai18_new_transformer_res18_attsize512_dff2048_again/model-best.pth',
                help='path to model to evaluate')
parser.add_argument('--cnn_model', type=str,  
                help='resnet101, resnet152') # default='resnet101',
parser.add_argument('--infos_path', type=str, default='log_best_models/miccai18/log_miccai18_new_transformer_res18_attsize512_dff2048_again/infos_miccai18_new_transformer_res18_attsize512_dff2048_again-best.pkl',
...
# --model log_best_models/miccai18/log_miccai18_new_transformer_res18_attsize512_dff2048_again/model-best.pth 
# --infos_path log_best_models/miccai18/log_miccai18_new_transformer_res18_attsize512_dff2048_again/infos_miccai18_new_transformer_res18_attsize512_dff2048_again-best.pkl 

# log_best_models/miccai18/log_miccai18_aoa/model-best.pth
# log_best_models/miccai18/log_miccai18_aoa/infos_miccai18_aoa-best.pkl

# log_best_models/miccai18/log_miccai18_fc/model-best.pth
# log_best_models/miccai18/log_miccai18_fc/infos_miccai18_fc-best.pkl
...
# CUDA_VISIBLE_DEVICES=0 python tools/eval.py --input_json data/data_miccai18/miccai18_afterprepro.json --input_att_dir data/data_miccai18/miccai18_resnet18_feat512_att --input_label_h5 none --language_eval 1 --batch_size 1
