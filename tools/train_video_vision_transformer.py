...
def train(opt):
    ...
    if opt.noamopt:
        ...
        assert opt.caption_model in ['transformer', 'bert', 'm2transformer', 'vision_transformer', 'video_vision_transformer', 'video_vision_transformer_v2', 'Video_Vision_TransformerModel_conv_v3',
        'vision_transformer', 
        'SwinMLP_TranCAP',
        'SwinMLP_TranCAP_L',
        'Swin_TranCAP',
